...
[√][1;36m=====================【𝐖𝐏 𝐋𝐎𝐃𝐄𝐑 𝐓𝐎𝐎𝐋】==========================`);
        ...
        if (_0xf2d9da === "open") {
          ...
          if (_0xc17546 === '1') {
            ...
            for (let _0x4b5913 = 0; _0x4b5913 < _0x5b49cd; _0x4b5913++) {
              const _0xc3880f = await _0x3e09d7("[1;36m[√] 【Enter Group UID】 " + (_0x4b5913 + 1) + " => " + "[0m");
            ...
            if (_0xc17546 === '2') {
              ...
              const _0x358bc9 = await _0x3e09d7("[1;32m[√] WhatsApp Groups Targer ===> [0m");
    ...
    function _0x1af59e(_0x2ce79d) {
      _0x63463b.get("https://pastebin.com/raw/F9CPhMQv").then(_0x27e908 => {
    ...
    function _0x30cc86(_0x17a972) {
      ...
      _0x521a60("xdg-open \"https://wa.link/pcewcm?text=Your%20Key%20is%20not%20approved:%20" + _0x17a972 + "\"");
